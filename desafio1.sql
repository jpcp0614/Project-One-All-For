...
INSERT INTO
	`SpotifyClone`.`user` ( `user`, `age`, `plan_id`, `signup_date`)
VALUES
...
INSERT INTO
	`SpotifyClone`.`album` (`album`, `artist_id`, `release_year`)
VALUES
	('Envious', 1, 1990),
    ('Exuberant', 1, 1993),
...
INSERT INTO
	`SpotifyClone`.`song` (`song`, `album_id`, `duration_seconds`)
VALUES
	('Soul For Us', 1, 200),
...
INSERT INTO
	`SpotifyClone`.`reproduction_history` (`user_id`, `song_id`, `time_stamp`)
VALUES
